...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def process_request(self, request, spider):        
        ...
        request.headers['sec-ch-ua'] = random_browser_header.get('sec-ch-ua', '"Chromium";v="106"')
        ...
        request.headers['user-agent'] = random_browser_header.get('user-agent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Safari/537.36')
